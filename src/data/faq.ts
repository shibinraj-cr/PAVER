...
export const faqData: FAQCategory[] = [
  {
    ...
    questions: [
      ...
      {
        question: 'Can I use tile adhesive for bathroom walls in high-humidity monsoon climates?',
      ...
      {
        question: 'Which tile adhesive is best for vitrified tiles in tropical climates?',
        answer: 'Paver Chemco C1TE is the recommended tile adhesive for vitrified tiles in tropical climates. Its higher polymer content provides excellent grip for the smooth, low-porosity back surface of vitrified tiles and accommodates thermal movement common in tropical climates\'s hotter climate.',
      },
      {
        question: 'How long does tile adhesive take to dry in tropical monsoon regions\'s humid climate?',
        answer: 'Paver Chemco tile adhesive allows light foot traffic after 24 hours and reaches full cure in 72 hours. In tropical monsoon regions\'s high-humidity conditions, particularly during monsoon, allow 48 hours before foot traffic and 96 hours for full cure.',
      },
      {
        question: 'What is the price of Paver Chemco tile adhesive in high-humidity monsoon climates?',
        answer: 'Contact your nearest Paver Chemco dealer or call +91 9994491827 / email business@furner.in for current pricing in tropical monsoon climates. Paver Chemco offers competitive pricing for both C1T (interior) and C1TE (exterior) tile adhesives.',
      },
    ],
  },
  {
    ...
    questions: [
      {
        question: 'What is the best mortar for AAC blocks in high-humidity monsoon climates?',
        answer: 'Paver Chemco Block Jointing Mortar is the best choice for AAC block construction in tropical monsoon climates. It requires only a 3 mm joint thickness (vs 12–15 mm for conventional mortar), provides ≥0.8 N/mm² tensile adhesion strength, and is self-curing — making it ideal for tropical monsoon climates\'s varied climate conditions.',
      },
      {
      ...
      {
        question: 'Can I use block jointing mortar for fly ash bricks in tropical climates?',
        answer: 'Yes. Paver Chemco Block Jointing Mortar is formulated for AAC blocks, fly ash bricks, and concrete blocks. It is suitable for all lightweight masonry construction in tropical climates, providing thin 3 mm joints and superior bond strength.',
      },
      {
  ...
  },
  {
    ...
    questions: [
      {
        question: 'How do I stop my terrace from leaking during monsoon season?',
      ...
      {
        question: 'What is the waterproofing solution for basement walls in tropical climates?',
        answer: 'For basements in tropical climates, apply Paver Chemco WP Membrane from the outside (positive side) before backfilling. Where only internal access is possible, apply from inside (negative side waterproofing). Use 2–3 coats at 1.0–1.2 kg/m² per coat for effective basement waterproofing.',
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: 'Allow a minimum of 24 hours after tiling with Paver Chemco tile adhesive before grouting. In high-humidity conditions like during monsoon season, wait 48 hours. Ensure the adhesive is fully set before applying grout.',
      },
      {
  ...
  },
  {
    ...
    questions: [
      {
        question: 'Where can I buy Paver Chemco products in high-humidity monsoon climates?',
        answer: 'Paver Chemco products are available through our authorised dealer network across our authorised dealer network. Contact us at business@furner.in or +91 9994491827 to find your nearest dealer.',
      },
      {
        question: 'Where can I buy Paver Chemco products in tropical climates?',
        answer: 'Paver Chemco products are distributed across our distribution network. Call +91 9994491827 or email business@furner.in to locate your nearest authorised dealer.',
      },
      {
