...
export const products: Product[] = [
  // ── 1. C1T — Interior Tile Adhesive ────────────────────────────────────────
  {
    ...
    seo: {
      title: 'C1T Interior Tile Adhesive | Best Tile Adhesive tropical monsoon regions',
      description: 'Buy Paver Chemco C1T polymer-modified tile adhesive for interior floors and walls. Coverage 4–4.5 kg/sqm. Available in tropical monsoon regions. 30 kg bag.',
      keywords: [
        'C1T tile adhesive tropical monsoon regions',
        'interior tile adhesive tropical monsoon regions',
        'tile adhesive for bathroom tropical monsoon regions',
        'C1T tile adhesive tropical climates',
        'best tile adhesive interior',
        'ceramic tile adhesive tropical monsoon regions',
        'tile adhesive 30kg price tropical monsoon regions',
        'tile adhesive the region',
  ...
  // ── 2. C1TE — Exterior Tile Adhesive ────────────────────────────────────────
  {
    ...
    faqs: [
      ...
      { question: 'Is C1TE suitable for tropical monsoon climates\'s monsoon conditions?', answer: 'Absolutely. C1TE is formulated with higher polymer content specifically to handle the wet and humid conditions typical of monsoon seasons. The adhesive maintains excellent bond strength even with regular exposure to rain and moisture once fully cured.' },
      ...
      { question: 'Can I use C1TE for vitrified tiles on outdoor floors in tropical climates?', answer: 'Yes, C1TE is the recommended product for vitrified tile installation on outdoor floors in tropical climates. The high polymer content provides excellent grip and thermal movement accommodation, critical for the high temperature variations experienced in tropical climates.' },
    ...
    seo: {
      title: 'C1TE Exterior Tile Adhesive | Vitrified Tile Adhesive tropical monsoon regions',
      description: 'Paver Chemco C1TE — superior exterior tile adhesive for vitrified tiles, tile-on-tile installation. Best tile adhesive for monsoon season and tropical climates climate. 30 kg bag.',
      keywords: [
        'exterior tile adhesive tropical monsoon regions',
        'vitrified tile adhesive tropical monsoon regions',
        'tile on tile adhesive India',
        'C1TE tile adhesive',
        'exterior tile adhesive tropical climates',
        'tile adhesive for terrace tropical monsoon regions',
        'tile adhesive monsoon tropical monsoon regions',
        'vitrified tile adhesive the region',
        'outdoor tile adhesive tropical monsoon regions',
  ...
  // ── 3. Block Jointing Mortar ─────────────────────────────────────────────────
  {
    ...
    faqs: [
      ...
      { question: 'Is block jointing mortar available in tropical monsoon regions?', answer: 'Yes, Paver Chemco Block Jointing Mortar is distributed across tropical monsoon regions through our dealer network. Contact us at business@furner.in or +91 9994491827 to find your nearest dealer.' },
    ...
    seo: {
      title: 'AAC Block Jointing Mortar tropical monsoon regions | Paver Chemco',
      description: 'Paver Chemco Block Jointing Mortar — polymer-modified mortar for AAC blocks, fly ash bricks, concrete blocks. 3 mm joint, >10 MPa compressive strength. Available tropical monsoon regions.',
      keywords: [
        'AAC block jointing mortar tropical monsoon regions',
        'block mortar tropical monsoon regions',
        'fly ash brick mortar tropical monsoon regions',
        'AAC block adhesive tropical climates',
        'block jointing mortar the region',
        'concrete block mortar tropical monsoon regions',
        'AAC block mortar price tropical monsoon regions',
        'block mortar the region',
        'lightweight block mortar tropical monsoon regions',
        'block mortar the region',
      ],
    },
  },
  ...
  // ── 4. Tile Grout ─────────────────────────────────────────────────────────────
  {
    ...
    faqs: [
      ...
      { question: 'How long after tiling can I apply grout?', answer: 'Wait a minimum of 24 hours after tiling before applying grout to allow the tile adhesive to set fully. In humid conditions (such as during monsoon season), allow 48 hours.' },
    ],
    ...
    seo: {
      title: 'Tile Grout tropical monsoon regions | Paver Chemco Cementitious Grout',
      description: 'Buy Paver Chemco Tile Grout — polymer-modified, 8 colours, interior & exterior use. Best tile grout for tropical monsoon regions homes. Available in 5 kg and 10 kg bags.',
      keywords: [
        'tile grout tropical monsoon regions',
        'grout for tiles tropical monsoon regions',
        'tile joint filler tropical monsoon regions',
        'tile grout tropical climates',
        'ceramic tile grout tropical monsoon regions',
        'grout colour tropical monsoon regions',
        'tile grout price tropical monsoon regions',
        'best tile grout India',
        'tile grout the region',
  ...
  // ── 5. Epoxy Grout ────────────────────────────────────────────────────────────
  {
    ...
    faqs: [
      ...
      { question: 'Can I use epoxy grout in a swimming pool in high-humidity monsoon climates?', answer: 'Yes, Paver Chemco Epoxy Grout is ideal for swimming pools. It provides complete water impermeability and resistance to pool chemicals including chlorine. Pools should not be filled for at least 21 days after grouting to allow full cure.' },
    ],
    relatedProducts: ['tile-grout', 'c1te-exterior-tile-adhesive', 'wp-membrane'],
    tdsFile: '/tds/TDS_PaverChemco_EpoxyGrout.pdf',
    seo: {
      title: 'Epoxy Grout tropical monsoon regions | Chemical Resistant Tile Grout',
      description: 'Paver Chemco Epoxy Grout — 3-component, zero water absorption, chemical resistant. Ideal for swimming pools, kitchens, hospitals in tropical monsoon regions.',
      keywords: [
        'epoxy grout tropical monsoon regions',
        'epoxy grout swimming pool tropical monsoon regions',
        'chemical resistant grout tropical monsoon regions',
        'epoxy tile grout tropical climates',
        'epoxy grout kitchen tropical monsoon regions',
        'epoxy grout price India',
        'best epoxy grout tropical monsoon regions',
        'waterproof grout tropical monsoon regions',
        'epoxy grout the region',
      ],
    },
  },
  ...
  // ── 6. Waterproofing Membrane ─────────────────────────────────────────────────
  {
    ...
    longDescription:
      'Paver Chemco WP Membrane is a single-component, ready-to-mix, acrylic polymer-modified flexible cementitious waterproofing coating. Applied in two or more coats, it forms a seamless, crack-bridging, durable membrane that bonds strongly to concrete, plaster, and masonry substrates. Engineered for tropical monsoon climates\'s monsoon conditions and tropical climates\'s heat — this is the professional waterproofing solution for terraces, bathrooms, water tanks, basements, and swimming pools.',
    features: [
      'Single-component — only water required',
    ...
    seo: {
      title: 'Waterproofing Chemical tropical monsoon regions | Paver Chemco WP Membrane',
      description: 'Paver Chemco WP Membrane — flexible cementitious waterproofing for terrace, bathroom, pool & basement. Best waterproofing chemical in tropical monsoon regions. 20 kg bag.',
      keywords: [
        'waterproofing chemical tropical monsoon regions',
        'terrace waterproofing tropical monsoon regions',
        'bathroom waterproofing tropical monsoon regions',
        'waterproofing membrane tropical monsoon regions',
        'waterproofing chemical tropical climates',
        'terrace waterproofing the region',
        'waterproofing solution monsoon season',
        'swimming pool waterproofing tropical monsoon regions',
        'basement waterproofing tropical monsoon regions',
        'waterproofing chemical the region',
        'waterproofing membrane the region',
      ],
    },
  },
]
